...
Through this project I got to know about useEffect Hook in react, which I used to change the state based on the screen/window width. Learned to apply animation with framer motion - react animation library
